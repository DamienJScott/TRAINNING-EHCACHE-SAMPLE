package com.ehc.generated.config.timezone;

import com.ehc.generated.EhcMonolithSampleApp;
import com.ehc.generated.repository.timezone.DateTimeWrapper;
import com.ehc.generated.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ehc_date_time_wrapper where id=%d", fieldName, id);
    }
